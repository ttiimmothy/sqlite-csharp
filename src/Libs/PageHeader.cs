...
namespace codecrafters_sqlite.Libs;
...
public record PageHeader(BTreePage PageType, ushort FirstFreeBlockStart, ushort NumberOfCells, ushort StartOfContentArea, byte FragmentedFreeBytes)
{
